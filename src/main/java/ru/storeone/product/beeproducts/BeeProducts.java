package ru.storeone.product.beeproducts;

import ru.storeone.product.Product;

public class BeeProducts extends Product {

    private double caloricContent, weight;

    public BeeProducts(String name, double caloricContent, double weight, String manufacturer, String countryOfOrigin, double price) {
